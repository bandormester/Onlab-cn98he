            ...
            if(l.getStudentId()!= null && l.getTeacherId()!=null){
                if(l.getTeacherId().equals(id) || l.getStudentId().equals(id)){
                    ...
                    if(teacher.isPresent() && student.isPresent() && topic.isPresent() && level.isPresent()){
                        ...
                        //Date realDate = new Date(date.getYear()+1900, date.getMonth(), date.getDate(), date.getHours()+1, date.getMinutes());
                        System.out.println("ora: "+new Date(l.getStartTime()).toString()+
                                "/n datum" + date.toString());//+
                                //"/n datum+1970" + realDate.toString());
