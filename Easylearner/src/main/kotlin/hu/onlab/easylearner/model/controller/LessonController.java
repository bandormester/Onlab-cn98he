...
public class LessonController {
    ...
    ResponseEntity<List<LessonWithNamesDto>> findLessonsAsStudent(@RequestParam Integer studentId){
        List<LessonWithNamesDto> queryResult = lessonService.findLessonAsStudent(studentId);
        return ResponseEntity.status(HttpStatus.OK).body(queryResult);
    }

    @GetMapping("/names/teacher")
    ResponseEntity<List<LessonWithNamesDto>> findLessonsAsTeacher(@RequestParam Integer teacherId){
        List<LessonWithNamesDto> queryResult = lessonService.findLessonAsTeacher(teacherId);
        return ResponseEntity.status(HttpStatus.OK).body(queryResult);
    }
